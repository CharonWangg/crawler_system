...
data_dir = 'data/economics'
os.makedirs(data_dir, exist_ok=True)


# Define the base URL
base_url = 'https://economics.ucsd.edu/faculty-and-research/faculty-profiles/index.html'
base_profile_url = 'https://economics.ucsd.edu/faculty-and-research/faculty-profiles'
